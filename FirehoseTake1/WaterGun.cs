...
namespace Firehose
{
    class WaterGun : Sprite
    {
        ...
        public WaterGun(int width, int height)
        {
        ...
        public void Update(Player player1, Controls controls, GameTime gameTime, FireParticleEngine fireParticleEngine)
        {
            ...
            FireWater(controls, gameTime, fireParticleEngine, player1, this); 
            AimWater(controls, gameTime);
        ...
        private void AimWater(Controls controls, GameTime gameTime)
        {
            //Aim Gun
        ...
        private void FireWater(Controls controls, GameTime gameTime, FireParticleEngine fireParticleEngine, Player player1, WaterGun waterGun1)
        {
